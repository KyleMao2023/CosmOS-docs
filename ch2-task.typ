...
$
  Delta_"fair" = Delta_"exec" times "NICE_0_LOAD" / "weight" \

  "vruntime" = "vruntime" + Delta_"fair"
$
...
$
  "vruntime"_"placed" = max("vruntime"_"old", "vruntime"_"min" - "CFS_WAKEUP_GRANULARITY_NS")
$
...
#figure(image("assets/timer_interrupt_reschedule_flow_preview.svg"), caption: [周期 timer 触发重新调度的路径])
...
#figure(image("assets/task_wait_block_wakeup_flow_preview.pdf"), caption: [阻塞与唤醒的通用模式])
